...
gbm = lgb.LGBMClassifier(n_estimators=50, silent=False)
...
onx = onnxmltools.convert.convert_lightgbm(gbm, name='LightGBM', initial_types=initial_type)
...
# plots
confusion_metrics = plot_confusion_matrix(gbm, X_test, y_test, display_labels=class_names, cmap=plt.cm.Blues)
confusion_metrics.ax_.set_title("Confusion matrix of LightGBM classifier on Iris dataset")
